...
with sync_playwright() as p:
    ...
    # aboutus = page.locator('(//a[text()="About us"])[1]')
    portfol=page.locator('//a[@href="https://www.tranktechnologies.com/portfolio"]').click()
    ...
    # cmswdv = page.locator('//a[@href="https://www.tranktechnologies.com/cms-website-development-company"]')
    # ecdv = page.locator('(//i[@class="fa fa-chevron-down text-red-2"])[1]')
    # wbdv = page.locator('//a[@href="https://www.tranktechnologies.com/website-development-company"]')
    # cdev = page.locator('//a[@href="https://www.tranktechnologies.com/custom-web-portal-development-company"]')

    # w_l = [cmswdv, ecdv, wbdv, cdev]
